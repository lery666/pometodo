...
export const settingsTexts = {
  ...
  aiCustomHint: "可接任意 OpenAI 兼容服务：Agnes、中转站或本机的 Ollama / LM Studio。",
  aiBaseUrlLabel: "接口地址",
  aiBaseUrlPlaceholder: "https://apihub.agnes-ai.com/v1",
  aiModelLabel: "模型名",
  aiModelPlaceholder: "agnes-2.0-flash",
  aiAgnesPreset: "填入 Agnes 预设",
  aiAgnesPresetApplied: "已填入 Agnes 预设并保存。",
  aiCustomIncomplete: "自定义服务还需填写接口地址与模型名。",
